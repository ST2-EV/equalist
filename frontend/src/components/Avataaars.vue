...
<script>
import { mouthTypes } from '../assets/assetsTypes/mouth'
import { eyeTypes } from '../assets/assetsTypes/eyes'
import { eyebrowTypes } from '../assets/assetsTypes/eyebrows'
import { clothesType } from '../assets/assetsTypes/clothes'
import { topTypes } from '../assets/assetsTypes/top'
import { accessoriesTypes } from '../assets/assetsTypes/accessories'
import { facialHairTypes } from '../assets/assetsTypes/facial-hair'
import { GraphicShirtTypes } from '../assets/assetsTypes/graphic-shirt'
import { hairColors, skinColors, hatAndShirtColors } from '../assets/assetsTypes/colors'
...
export default {
    ...
    methods: {
        getRandomChoice (items) {
            ...
            if (this.identifier === "random"){
                return Object.entries(items)[Math.floor((Math.random()*(itemsLength)))][1]
            } else{
                var rng = seedrandom(this.identifier);
                return Object.entries(items)[Math.floor((rng()*(itemsLength)))][1]
            }  
        }
    },
    data () {
